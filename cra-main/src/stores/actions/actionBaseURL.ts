...
interface TypeActionBaseWebsocketURL extends TypeActionBaseHostURL {}

const setBaseHostURL = (baseURL: string): TypeActionBaseHostURL => ({ type: types.SET_BASE_URL, data: baseURL });
/**
 * baseURL
 * @param baseURL
 */
